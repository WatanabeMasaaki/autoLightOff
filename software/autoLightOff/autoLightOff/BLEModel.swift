...
class BLEModel: NSObject, ObservableObject {
    ...
    // 接続時に用いるServiceUUID
    let bleServiceUUID = CBUUID(string: "ee46ee64-ca0c-4cd3-8b87-bb02d813650a")
    // 各Characteristic
    let bleWriteCharacteristicUUID = CBUUID(string:"5d105679-20c4-448d-85e9-fcd75bf2c89d")
    let bleNotifyCharacteristicUUID = CBUUID(string:"6afeb308-af0d-4a1f-9f0d-24b35ec5535d")
